	...
	<body>
				...
				<div class="container">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="/">
							<img alt="" src="https://dfinity.org/img/logo.png">
							<span>DFINITY</span>
						</a>
			...
			<section id="network">
				...
				<div class="container">
					...
					<div class="row splash-body">
						<div class="col-sm-6">
							<div class="console hidden-xs hidden-sm">
								<div class="terminal"></div>
							</div>
						</div>
					</div>

					<div class="row splash-footer"></div>
		...
		(function($) {
			...
			function resize() {
				...
				$('.splash-body').css('height', $(window).height() * 0.5);
				$('.splash-footer').css('height', $(window).height() * 0.5);
